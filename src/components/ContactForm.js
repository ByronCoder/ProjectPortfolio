...
class ContactForm extends React.Component { 
    ...
    handleEmailSubmit = () => {
        alert("Sorry! Email Form not yet implemented. Site undercontruction.")
    }
        ...
        <div className="row">
                <div className="col-lg-8 mx-auto">
                    ...
                    <div className="form-group">
                        <button type="submit" onClick={this.handleEmailSubmit} className="btn btn-primary btn-xl" id="sendMessageButton">Send</button>
                    </div>
                    </form>
                    </div>
                 </div>
